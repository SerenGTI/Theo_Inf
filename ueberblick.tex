\chapter{Überblick}
Ein kurzer Gesamtüberblick über den Zusammenhang von formalen Sprachen zur Berechenbarkeitstheorie:
...
\definecolor{entscheidbar}{rgb}{0.4, 0.9, 0.7}
	...
	\begin{tikzpicture}
		...
		\draw [dotted, line width=0.2mm] (0,0) rectangle (14,16.5);
		\draw node at (7,16.5) [grouplabel] {alle formalen Sprachen};


		% CO-SEMI-ENTSCHEIDBAR
		\draw [dotted, line width=0.5mm] (0.5,0.5) rectangle (12,12);%co-semi
		...
		% SEMI-ENTSCHEIDBAR
		\draw [dotted, line width=0.5mm] (2,2) rectangle (13.5,15.5);%semi
		...
		%ENTSCHEIDBAR
		\draw [draw, fill=white, line width=0.5mm] (2,2) rectangle (12,12);
		\draw [draw, fill=accent, opacity=0.5, line width=0.5mm] (2,2) rectangle (12,12);%entscheidbar
		...
		%% TYP1
		\draw [line width=0.2mm] (2.2,2.2) rectangle (11.8,9.9);
		...
		%% TYP2
		\draw [line width=0.2mm] (2.4,2.4) rectangle (11.6,8.1);
		\draw node at (7,8.1) [grouplabel] {\hyperref[sec:typ2]{Typ-2$=\cfl$}};
		\draw node at (2.4,7.4) [label={right:$a^na^n, aa^R, \ldots$}] {};
		\draw node at (2.4,6.9) [label={right:PDA}] {};

		% DCFL
		\draw [line width=0.2mm] (2.6,2.6) rectangle (11.4,6.3);%dcfl
		\draw node at (7,6.3) [grouplabel] {\hyperref[sec:typ2]{$\dcfl$}};
		\draw node at (2.6,5.6) [label={right:$a^nb^n, a\$a^R, \ldots$}] {};
		\draw node at (2.6,5.1) [label={right:DPDA}] {};

		% TYP3
		\draw [line width=0.2mm] (2.8,2.8) rectangle (11.2,4.5);
